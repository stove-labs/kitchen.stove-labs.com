...
<sup>1</sup>) Number of total tokens transfered in that operation<br/>
<sup>2</sup>) Number of different token IDs involved in that operation
<sup>3</sup>) Number of different token owners (addresses) involved in that operation
